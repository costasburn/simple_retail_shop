...
new_store.purchase_item(item=Book, quantity=100, journal=new_journal, invoice_in=new_invoice_in)
new_store.purchase_item(item=Pen, quantity=1000, journal=new_journal, invoice_in=new_invoice_in)
new_store.sell_item(item=Pen, quantity=34, journal=new_journal, invoice_out=new_invoice_out)
new_store.sell_item(item=Pen, quantity=21, journal=new_journal, invoice_out=new_invoice_out)
...
new_report.print_invoices(new_journal.get_invoices())
new_store.sell_item(invoice_out=new_invoice_out, item=Pen, journal=new_journal, quantity=2)